...
<body>
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="front-page/logo2.png" style="width:100px;top:-20px;position: absolute;" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
  ...
  <!-- START FOOTER -->
  <footer class="page-footer foodfast-theme">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2018 <a class="grey-text text-lighten-4" href="#" target="_blank">Frank</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Gatero</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
