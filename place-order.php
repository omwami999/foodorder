        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="front-page/logo2.png" style="width:100px;top:-20px;position: absolute;" alt="logo"></span></h1></li>
                    </ul>
                    ...
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> Orders</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="ordeKsh.php">All Orders</a>
                                </li>
								<?php
...
<div>
  <style type="text/css">
    label{position:absolute;margin-bottom: 30px;}
  </style>
              ...
              <span class="importantDiag">
							<select id="payment_type" name="payment_type">
									<option value="Wallet" selected>Wallet</option>
                  <option value="Cash on Delivery">Cash on Delivery</option>
                  <!-- 
									<option value="<?php //if($verified) echo "<script>alert('disabled')</script>";?>">Cash on Delivery</option>	 -->						
							</select>
            </span>
...
<?php
	...
	foreach ($_POST as $key => $value)
	{
		...
		while($row = mysqli_fetch_array($result))
		{
			...
			$item_name = $row['name'];
			$item_id = $row['id'];
           $picture_order = $row['item_pic'];
		}
			$price = $value*$price;
			    echo '<li class="collection-item">
        <div class="row">
            <div class="col s7">
                <p class="collections-title"><img style="width:70px; height:70px" src="images/'.$picture_order.'"></p>
            </div>
            <div class="col s7">
...
?>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2018 <a class="grey-text text-lighten-4" href="#" target="_blank"></a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Frank</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
