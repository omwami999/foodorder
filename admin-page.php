...
<head>
  ...
  <!-- For iPhone -->
  <meta name="msapplication-TileColor" content="#e87b09">
...
<body>
  ...
  <!-- START HEADER -->
  <header id="header" class="page-topbar foodfast-theme">
        <!-- start header nav-->
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="front-page/logo2.png" style="width:100px;top:-20px;position: absolute;" alt="logo"></a> <span class="logo-text"></span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <div class="container">
          ...
          <p class="caption" style="font-size: 15px"><strong>NOTE: </strong>Drag images to the /images/ directory before Adding and Changing pictures of items.</p>
...
<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
				...
				{
          echo '<tr><td><div class="input-field col s12"><label for="'.$row["item_pic"].'_name"></label>';
          echo '<img src="images/'.$row['item_pic'].'" style="width:50px; height:50px;">';
          echo '<td><div class="input-field col s12"><label for="'.$row["item_pic"].'_name"></label>';
          //change picture
          echo '<input data-readonly value="" id="'.$row["id"].'_pic" name="'.$row['id'].'_pic" type="file" style="display:none;" data-error=".errorTxt'.$row["id"].'">';
          $action = "javascript:document.getElementById('".$row["id"]."_pic').click()";
          echo '<a id="changepic" href='.$action.' style="border:none; color:#fff;background:#ff6666;width:150px;cursor:pointer;padding:10px;">Add / Change Picture</a>
          <input value="'.$row["item_pic"].'" id="'.$row["id"].'_namepic" name="'.$row['id'].'_name" type="text" data-error=".errorTxt'.$row["id"].'">

          <script>
            var pictureInput = $("#'.$row["id"].'_pic");
            var pictureOutput = $("#'.$row["id"].'_namepic");

          pictureInput.on("change", function (){
                var output_data = pictureInput.val();
                var pic_output = output_data.slice(12);
                pictureOutput.val(pic_output);
          })
          </script>
...
<table>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2017 <a class="grey-text text-lighten-4" href="#" target="_blank">Frank</a> All rights reserved.</span>
